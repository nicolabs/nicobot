...
- debian-slim : ![debian-slim](https://img.shields.io/badge/docker/image-size/:nicolabs/:nicobot/:debian-slim)
![layers](https://img.shields.io/badge/microbadger/layers/:nicolabs/:nicobot/:debian-slim)
